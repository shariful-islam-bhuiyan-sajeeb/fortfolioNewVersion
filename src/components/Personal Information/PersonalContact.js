  ...
  return (
    <div>
      <div className="flex md:flex-row flex-col md:items-start items-center lg:justify-normal justify-center ">
        <div className="lg:w-2/5 md:w-2/5 sm:w-3/4 w-11/12 mx-auto">
          <img
        ...
        <div className="md:w-3/5 w-11/12 mx-auto lg:px-0 px-4 sm:mt-0 mt-3">
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex items-center xl:gap-x-4 lg:gap-x-3 gap-x-2 lg:mt-6 mt-4">
              <a
                href="#_"
                class="relative inline-flex items-center lg:px-8 px-6 lg:py-2 py-1 overflow-hidden lg:text-md text-sm font-medium text-gray-300 border border-red-500 rounded-full hover:text-white group hover:bg-gray-50"
              >
                <span class="absolute left-0 block w-full h-0 transition-all bg-red-500 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
                <span class="absolute right-0 flex items-center justify-start w-8 h-8 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
                  <svg
                    class="w-5 h-3"
                    fill="none"
                    stroke="currentColor"
